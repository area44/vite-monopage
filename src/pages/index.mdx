...
<Steps>
  <Step title="Clone Template">
    ...
    https://github.com/area44/vite-monopage.git ```
  </Step>
  <Step title="Install Dependencies">
    Install the required packages using pnpm. ```bash pnpm install ```
  </Step>
  <Step title="Start Developing">Launch the development server. ```bash pnpm dev ```</Step>
</Steps>
